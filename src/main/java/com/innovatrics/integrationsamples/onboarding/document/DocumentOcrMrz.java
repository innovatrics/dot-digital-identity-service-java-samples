...
public class DocumentOcrMrz {
    ...
    public static void main(String[] args) throws IOException, URISyntaxException {
        ...
        try {
            ...
            CreateDocumentPageResponse createDocumentResponse = customerOnboardingApi.createDocumentPage(customerId, new CreateDocumentPageRequest().image(new Image().data(getDocumentImage("document-back"))));
