 ...
 */
public class CustomerOnboardingWithSession {
    ...
    public static void main(String[] args) throws IOException, URISyntaxException {
        ...
        final SessionManagementApi sessionManagementApi = new SessionManagementApi(client);
        ...
        try {
            ...
            client.addDefaultHeader("x-inn-session-token", sessionToken);
